...
const CommunitySupport = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b  bg-{#f6e7d8} flex flex-col items-center">
      <div className="text-black text-center p-8">
        <img src={Logo} alt="HealthXpress Logo" className="w-24 mx-auto mb-2" />
        <h1 className="text-4xl font-semibold mb-4 text-black">Welcome to Community-Support</h1>
        {/* {isAuthenticated ? ( */}
          <div>
          <div className="flex justify-end items-center mb-4">
            <p className="text-lg mr-4">Welcome, 
            {/* {user.name} */}
            User
            !
            </p>
