  ...
  return (
    <div className="home-page">
        ...
        <Container className="header-container">
          <Row>
            <Col xs="12" lg="6" className="header-text">
              <h1 className="header-brand">MindCure</h1>
              <p className="header-motto">
              Wrap your thoughts in the warmth of positivity, where every breath is a 
                melody of well-being with a digital way to track and uplift your mood.
              </p>
              {user ? (
                <Button
                  style={{ marginLeft: 10 }}
      ...
      <section className="footer">
        Made with <FaHeart style={{ color: "#F68989" }} /> by MindCure-Team.
      </section>
    </div>
  );
};
